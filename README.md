...
通知：2017-02-19
====================================================================
Q：B站播放器又更新了！下次列表更新是什么时候？
A：等[这个游戏](http://fractalsoftworks.com/)下次更新的时候~~~~~~

更新：2016-12-14
====================================================================
由于B站更新了基于Html5的播放器，不支持正则表达式中的注释语法，故临时发布第⑨版。
第九版除了分为基本版和进阶版外，每个版本亦有用于Flash和Html5播放器的专用版，各位先临时试用一下~
